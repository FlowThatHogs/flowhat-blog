...
![Workspace agents 이미지 2: trigger, process, tools 구조를 보여주는 워크플로우 다이어그램](../../assets/workspace-agents/workspace-agents-2.svg)
...
![Workspace agents 이미지 5: 개인용 GPT에서 팀용 workflow agent로 넘어가는 방향](../../assets/workspace-agents/workspace-agents-5.svg)
...
![Workspace agents 이미지 3: 승인, 권한, governance가 핵심이라는 점을 보여주는 시각화](../../assets/workspace-agents/workspace-agents-3.svg)
...
![Workspace agents 이미지 4: 클라우드에서 계속 돌아가는 workflow hub로서의 ChatGPT](../../assets/workspace-agents/workspace-agents-4.svg)
