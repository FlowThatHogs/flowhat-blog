...
![Workspace agents 图 2：trigger、process、tools 组成的可重复工作流结构](../../assets/workspace-agents/workspace-agents-2.svg)
...
![Workspace agents 图 5：从个人 GPT 走向团队共享 workflow agent 的方向变化](../../assets/workspace-agents/workspace-agents-5.svg)
...
![Workspace agents 图 3：审批、权限和治理并不是附加项，而是核心产品层](../../assets/workspace-agents/workspace-agents-3.svg)
...
![Workspace agents 图 4：ChatGPT 作为云端持续运行的 workflow hub 的产品方向](../../assets/workspace-agents/workspace-agents-4.svg)
